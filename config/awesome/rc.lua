...
awful.keyboard.append_global_keybindings({
	...
	end, { description = "toggle multi monitor", group = "launcher" }),
	...
	awful.key({ modkey }, ";", function()
		os.execute("brightnessctl -q set 10%+")
	...
	awful.key({ modkey }, "x", function()
		os.execute(string.format("$HOME/.config/rofi/bin/runner"))
	end, { description = "execute prompt", group = "launcher" }),
	awful.key({ modkey, "Shift" }, "s", function()
		os.execute(string.format("$HOME/.config/rofi/bin/screenshot"))
